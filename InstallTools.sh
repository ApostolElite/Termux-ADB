...
wget https://github.com/ApostolElite/Termux-ADB/tree/master/bin/adb -P $downpath/ -q
echo -e "\e[32m[*] \e[34mDownloading binaries..."
wget https://github.com/ApostolElite/Termux-ADB/tree/master/bin/adb.bin -P $downpath/ -q
wget https://github.com/ApostolElite/Termux-ADB/tree/master/bin/fastboot -P $downpath/ -q
wget https://github.com/ApostolElite/Termux-ADB/tree/master/bin/fastboot-armeabi -P $downpath/ -q
